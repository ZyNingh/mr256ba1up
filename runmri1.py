...
ITERATION = 1
for BETACO in [0.1,0.01,0.05,0.0005]:
    ...
    for i in range(7):
        imageio.imwrite(".//beta" + str(BETAC)+"//RawB"+ str(i+1) + "beta" + str(BETACO) +".png",torch.sqrt(torch.sum(data['x'][i, :, :, :]**2, dim=2)))
